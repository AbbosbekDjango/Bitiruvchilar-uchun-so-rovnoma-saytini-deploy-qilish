...
def insert(request):  # sourcery skip: extract-method, last-if-guard
    if request.method =="POST":
        ...
        print(hemis_id,fish,jinsi,pasport_jshshr,pasport_seriya,tugilgan_sana,yonalish_nomi,gk,viloyat,tuman,mfy,umumiy_manzil,telefon1,telefon2,oila,farzand,farzand_yoshi,ish_faoliyat,xozirgi_ish,ish_manzil,ish_masofa,lavozim,qaysi_tizimda_ishlash,qoshimcha_izoh,oilaviy_biznes,oilaviy_biznes2,kredit_olish,kredit_summa,kredit_maqsad,biznes_izox)
        students=Talabalar(hemis_id=hemis_id,fish=fish,jinsi=jinsi,pasport_jshshr=pasport_jshshr,pasport_seriya=pasport_seriya,
        tugilgan_sana=tugilgan_sana,yonalish_nomi=yonalish_nomi,gk=gk,viloyat=viloyat,tuman=tuman,mfy=mfy,umumiy_manzil=umumiy_manzil,telefon1=telefon1,telefon2=telefon2,oila=oila,farzand=farzand,farzand_yoshi=farzand_yoshi,ish_faoliyat=ish_faoliyat,xozirgi_ish=xozirgi_ish,ish_manzil=ish_manzil,ish_masofa=ish_masofa,lavozim=lavozim,qaysi_tizimda_ishlash=qaysi_tizimda_ishlash,qoshimcha_izoh=qoshimcha_izoh,oilaviy_biznes=oilaviy_biznes,oilaviy_biznes2=oilaviy_biznes2,kredit_olish=kredit_olish,kredit_summa=kredit_summa,kredit_maqsad=kredit_maqsad,biznes_izox=biznes_izox)
        students.save()
        return redirect('/')
